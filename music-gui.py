...
def query_and_download(text):
	...
	print("{} results found. Downloading song number {}.".format(
	    len(search_results), int(num)))
...
class SearchBox(Frame):
    """
               this class is  search box changes colour when we write and other functionality to look like a search box
        """
